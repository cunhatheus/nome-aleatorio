...
function randomName() {
    ...
    let beforeLast;
    let grandpaLast;
    let minTarget = Number(minInput.value);
    let maxTarget = Number(maxInput.value);
    let length = Math.floor(Math.random() * (maxTarget - minTarget) + minTarget);
...
//max and min button generated by some shitty AI
